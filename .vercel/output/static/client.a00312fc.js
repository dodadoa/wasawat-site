import { r as yn } from "./chunks/index.6e195632.js"
var No = { exports: {} },
  ve = {},
  zo = { exports: {} },
  Po = {}
      ...
      e: for (var B = 0, Y = C.length, Xt = Y >>> 1; B < Xt; ) {
        ...
        if (0 > l(al, P))
          mn < Y && 0 > l(Gt, al)
            ? ((C[B] = Gt), (C[mn] = P), (B = mn))
            : ((C[B] = al), (C[pn] = P), (B = pn))
        else if (mn < Y && 0 > l(Gt, P)) (C[B] = Gt), (C[mn] = P), (B = mn)
        else break e
      }
    }
    return z
...
function Gn(e, n) {
  for (zt[e] = n, e = 0; e < n.length; e++) Lo.add(n[e])
}
var He = !(
    typeof window > "u" ||
...
function Wo() {
  if (Qn) {
    var e = Qn,
      n = $n
    if ((($n = Qn = null), Nu(e), n)) for (e = 0; e < n.length; e++) Nu(n[e])
  }
}
function Qo(e, n) {
  return e(n)
...
function Ba(e, n, t, r, l, i, u, o, s) {
  ;(wt = !1), (Cr = null), Va.apply(Ha, arguments)
}
...
function Xo(e) {
  return (e = Qa(e)), e !== null ? Go(e) : null
}
function Go(e) {
...
function dr(e) {
  ...
  for (var n = e.targetContainers; 0 < n.length; ) {
    ...
    } else return (n = Kt(t)), n !== null && ji(n), (e.blockedOn = t), !1
    n.shift()
  }
  return !0
}
...
function at(e, n) {
  e.blockedOn === n &&
    ((e.blockedOn = null),
    ql ||
      ((ql = !0), me.unstable_scheduleCallback(me.unstable_NormalPriority, lc)))
}
function Rt(e) {
  function n(l) {
    return at(l, e)
...
var Pr = null
function bl(e, n, t, r) {
  if (((Pr = null), (e = Oi(r)), (e = gn(e)), e !== null))
...
var tt = {
  ...
  ac = he(sc),
  cc = A({}, $t, { relatedTarget: 0 }),
  yl = he(cc),
  fc = A({}, tt, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  dc = he(fc),
  pc = A({}, tt, {
...
var kc = A({}, $t, {
  ...
  xc = he(Cc),
  _c = A({}, tt, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Nc = he(_c),
  zc = A({}, Yr, {
    deltaX: function (e) {
...
var Lc = He && "TextEvent" in window && !kt,
...
function Rc(e, n) {
  if (Dn)
    return e === "compositionend" || (!Bi && as(e, n))
      ? ((e = os()), (pr = Ai = Je = null), (Dn = !1), e)
      : null
  switch (e) {
    case "paste":
      return null
...
function fs(e, n, t, r) {
  Bo(r),
    (n = Tr(n, "onChange")),
    0 < n.length &&
      ((t = new Vi("onChange", "change", null, t, r)),
...
function Au() {
  St && (St.detachEvent("onpropertychange", ps), (Dt = St = null))
}
function ps(e) {
  if (e.propertyName === "value" && Xr(Dt)) {
    var n = []
    fs(n, Dt, e, Oi(e)), Ko(Oc, n)
  }
}
function Ic(e, n, t) {
  e === "focusin"
    ? (Au(), (St = n), (Dt = t), St.attachEvent("onpropertychange", ps))
    : e === "focusout" && Au()
}
function jc(e) {
...
var yt =
  ...
  $c = new Set("cancel close invalid load scroll toggle".split(" ").concat(yt))
function Qu(e, n, t) {
...
var rt = Math.random().toString(36).slice(2),
  ...
  ui = "__reactEvents$" + rt,
  Jc = "__reactListeners$" + rt,
  qc = "__reactHandles$" + rt
function gn(e) {
  var n = e[De]
  if (n) return n
...
function dn() {
  if (!Nl && je !== null) {
    ...
    try {
      ...
      throw (je !== null && (je = je.slice(e + 1)), Zo(Fi, dn), l)
    } finally {
      ;(M = n), (Nl = !1)
    }
  }
...
var Un = [],
  ...
  Ae = ""
function vn(e, n) {
  ;(Un[An++] = Or), (Un[An++] = Dr), (Dr = e), (Or = n)
}
function Ns(e, n, t) {
  ;(ye[ge++] = Ue), (ye[ge++] = Ae), (ye[ge++] = xn), (xn = e)
  var r = Ue
  e = Ae
  var l = 32 - Pe(r) - 1
  ;(r &= ~(1 << l)), (t += 1)
...
function $i(e) {
  for (; e === Dr; )
    (Dr = Un[--An]), (Un[An] = null), (Or = Un[--An]), (Un[An] = null)
  for (; e === xn; )
    (xn = ye[--ge]),
      (ye[ge] = null),
      (Ae = ye[--ge]),
  ...
  switch (e.tag) {
    ...
    case 13:
      return (
        ...
        n !== null
          ? ((t = xn !== null ? { id: Ue, overflow: Ae } : null),
            (e.memoizedState = {
              dehydrated: n,
              treeContext: t,
...
function di(e, n, t, r) {
  var l = e.stateNode
  ;(l.props = t), (l.state = e.memoizedState), (l.refs = Ms), Ji(e)
  var i = n.contextType
  typeof i == "object" && i !== null
    ? (l.context = Se(i))
  ...
  if (
    ...
    if (t._owner) {
      ...
      return n !== null &&
        ...
        : ((n = function (u) {
            var o = l.refs
            o === Ms && (o = l.refs = {}), u === null ? delete o[i] : (o[i] = u)
          }),
          (n._stringRef = i),
          n)
    }
...
function Ds(e) {
  ...
  function m(c, a, f) {
    ...
    if (typeof a == "object" && a !== null) {
      ...
      if (vt(a) || ut(a)) return (a = En(a, c.mode, f, null)), (a.return = c), a
      or(c, a)
    }
    return null
  }
  ...
  function k(c, a, f, h) {
    ...
    for (
      var x = (E = null), _ = a, N = (a = 0), H = null, T = f.next();
      _ !== null && !T.done;
      N++, T = f.next()
    ) {
      _.index > N ? ((H = _), (_ = null)) : (H = _.sibling)
...
function tu(e, n, t, r, l, i) {
  if (
    ...
    (n.updateQueue = null),
    (n.lanes = 0),
    (hr.current = e === null || e.memoizedState === null ? uf : of),
    (e = t(r, l)),
    Ct)
  ) {
    i = 0
...
function As(e, n, t, r) {
  ;(n.value = t), (n.getSnapshot = r), Hs(n) && Bs(e)
}
function Vs(e, n, t) {
  return t(function () {
    Hs(n) && Bs(e)
...
function Ys(e, n, t) {
  return (
    (t = t != null ? t.concat([e]) : null), br(4, 4, Ks.bind(null, n, e), t)
  )
}
function iu() {}
function Xs(e, n) {
...
function Zs(e, n, t) {
  return (_n & 21) === 0
    ...
    : (Le(t, n) || ((t = bo()), (U.lanes |= t), (Nn |= t), (e.baseState = !0)),
      n)
}
function tf(e, n) {
  var t = M
...
function lf(e, n, t) {
  ...
  if (qs(e)) bs(n, l)
    ...
    ;(t = Ts(e, n, l, r)),
      t !== null && ((l = le()), Te(t, e, r, l), ea(t, n, r))
  }
}
function qs(e) {
  var n = e.alternate
...
var Vr = {
  ...
  uf = {
    ...
    useTransition: function () {
      var e = lo(!1),
        n = e[0]
      return (e = tf.bind(null, e[1])), (Re().memoizedState = e), [n, e]
    },
  ...
  return (
    ...
    e !== null && !oe
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Qe(e, n, l))
      : (I && t && Qi(n), (n.flags |= 1), re(e, n, r, l), n.child)
  )
}
  ...
  return (
    ...
    e !== null && !oe
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Qe(e, n, l))
      : (I && r && Qi(n), (n.flags |= 1), re(e, n, t, l), n.child)
  )
}
function fo(e, n, t, r, l) {
  ...
  if ((Yn(n, l), n.stateNode === null))
    gr(e, n), Rs(n, t, r), di(n, t, r, l), (r = !0)
  else if (e === null) {
    var u = n.stateNode,
      o = n.memoizedProps
    u.props = o
...
function vi(e, n, t, r, l, i) {
  ia(e, n)
  var u = (n.flags & 128) !== 0
  if (!r && !u) return l && Zu(n, t, !1), Qe(e, n, i)
...
function po(e, n, t, r, l) {
  return Jn(), Ki(l), (n.flags |= 256), re(e, n, t, r), n.child
}
...
function oa(e, n, t) {
  ...
  if (i) {
    ...
    return (
      ...
      o !== null ? (i = on(o, i)) : ((i = En(i, u, t, null)), (i.flags |= 2)),
      (i.return = n),
      (r.return = n),
      (r.sibling = i),
      (n.child = r),
...
function ff(e, n, t, r, l, i, u) {
  if (t)
    return n.flags & 256
      ...
      : ((i = r.fallback),
        ...
        (n.memoizedState = hi),
        i)
  if ((n.mode & 1) === 0) return sr(e, n, u, null)
  if (l.data === "$!") {
  ...
  if (((o = (u & e.childLanes) !== 0), oe || o)) {
    ...
    return du(), (r = Ml(Error(y(421)))), sr(e, n, u, r)
  }
  return l.data === "$?"
    ? ((n.flags |= 128),
      (n.child = e.child),
      ...
      if (!r.hasOwnProperty(d) && l.hasOwnProperty(d) && l[d] != null)
        if (d === "style") {
          ...
          d !== "dangerouslySetInnerHTML" &&
            ...
            d !== "autoFocus" &&
            (zt.hasOwnProperty(d) ? i || (i = []) : (i = i || []).push(d, null))
    for (d in r) {
      var s = r[d]
      if (
        ((o = l?.[d]),
        ...
        (e === null || e.child === null) &&
          (ur(n)
            ...
            : e === null ||
              ...
              ((n.flags |= 1024), ze !== null && (Ni(ze), (ze = null)))),
        gi(e, n),
        ee(n),
        null
      )
...
function da(e) {
  ...
  n !== null && ((e.alternate = null), da(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[De], delete n[jt], delete n[ui], delete n[Jc], delete n[qc])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Te(e, n, t, r) {
  if (50 < Nt) throw ((Nt = 0), (xi = null), Error(y(185)))
  Qt(e, t, r),
    ((L & 2) === 0 || e !== G) &&
      (e === G && ((L & 2) === 0 && (nl |= t), K === 4 && Ze(e, J)),
      ce(e, r),
      t === 1 &&
        L === 0 &&
        (n.mode & 1) === 0 &&
...
function ce(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Pu(t), n === 1))
      e.tag === 0 ? bc(So.bind(null, e)) : _s(So.bind(null, e)),
        Gc(function () {
          ;(L & 6) === 0 && dn()
        }),
        (t = null)
...
function ya(e, n) {
  if (((wr = -1), (kr = 0), (L & 6) !== 0)) throw Error(y(327))
  var t = e.callbackNode
  ...
  if (n !== 0) {
    if (
      (n === 2 && ((l = Jl(e)), l !== 0 && ((r = l), (n = _i(e, l)))), n === 1)
    )
      throw ((t = Wt), Sn(e, 0), Ze(e, r), ce(e, W()), t)
    if (n === 6) Ze(e, r)
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            (Ze(e, r), (r & 130023424) === r && ((n = au + 500 - W()), 10 < n))
          ) {
            if (Nr(e, 0) !== 0) break
...
function So(e) {
  ...
  Xn()
  var n = Nr(e, 0)
  if ((n & 1) === 0) return ce(e, W()), null
  var t = Qr(e, n)
  if (e.tag !== 0 && t === 2) {
    var r = Jl(e)
    r !== 0 && ((n = r), (t = _i(e, r)))
  }
  if (t === 1) throw ((t = Wt), Sn(e, 0), Ze(e, n), ce(e, W()), t)
...
function cu(e, n) {
  ...
  try {
    ...
    ;(L = t), L === 0 && ((nt = W() + 500), Jr && dn())
  }
}
function zn(e) {
  qe !== null && qe.tag === 0 && (L & 6) === 0 && Xn()
  var n = L
  L |= 1
  var t = ke.transition,
    r = M
...
function Sn(e, n) {
  ...
  if ((t !== -1 && ((e.timeoutHandle = -1), Xc(t)), Q !== null))
...
function du() {
  ;(K === 0 || K === 3 || K === 2) && (K = 4),
    G === null || ((Nn & 268435455) === 0 && (nl & 268435455) === 0) || Ze(G, J)
}
function Qr(e, n) {
  var t = L
  L |= 2
  ...
  while (1)
  if ((Xi(), (L = t), (Hr.current = r), Q !== null)) throw Error(y(261))
  return (G = null), (J = 0), K
}
function kf() {
  for (; Q !== null; ) ka(Q)
...
function Cf(e, n, t) {
  ...
  r !== null && r.delete(n),
    ...
    G === e &&
      (J & t) === t &&
      (K === 4 || (K === 3 && (J & 130023424) === J && 500 > W() - au)
        ? Sn(e, 0)
        : (su |= t)),
    ce(e, n)
}
function Ea(e, n) {
  ...
  var t = le()
  ;(e = We(e, n)), e !== null && (Qt(e, n, t), ce(e, t))
}
function xf(e) {
  var n = e.memoizedState,
    t = 0
  ...
  if (e !== null)
    if (e.memoizedProps !== n.pendingProps || se.current) oe = !0
      ...
      if ((e.lanes & t) === 0 && (n.flags & 128) === 0)
        return (oe = !1), df(e, n, t)
      oe = (e.flags & 131072) !== 0
    }
  else (oe = !1), I && (n.flags & 1048576) !== 0 && Ns(n, Or, n.index)
  switch (((n.lanes = 0), n.tag)) {
    case 2:
      var r = n.type
      gr(e, n), (e = n.pendingProps)
      var l = Zn(n, te.current)
      Yn(n, t), (l = tu(null, n, r, e, l, t))
      var i = ru()
      return (
        (n.flags |= 1),
        typeof l == "object" &&
        ...
        l.$$typeof === void 0
          ? ((n.tag = 1),
            ...
            di(n, r, e, t),
            (n = vi(null, n, r, !0, i, t)))
          : ((n.tag = 0), I && i && Qi(n), re(null, n, l, t), (n = n.child)),
        n
      )
    case 16:
      r = n.elementType
  ...
  if (((r = e), typeof e == "function")) pu(e) && (u = 1)
    ...
    e: switch (e) {
      ...
      case Mi:
        ...
        break
      case Il:
        return (e = we(12, t, n, l | 2)), (e.elementType = Il), (e.lanes = i), e
      case jl:
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Ii(n, t | 1), ce(n, W()), (L & 6) === 0 && ((nt = W() + 500), dn()))
      }
      break
    case 13:
      zn(function () {
...
Qo = cu
$o = zn
var Rf = { usingClientEntryPoint: !1, Events: [Kt, In, Zr, Bo, Wo, cu] },
  pt = {
  ...
  Df = {
    ...
    findFiberByHostInstance: pt.findFiberByHostInstance || Lf,
...
if (typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u") {
  ...
  if (!fr.isDisabled && fr.supportsFiber)
    try {
      ;(Kr = fr.inject(Df)), (Oe = fr)
    } catch {}
}
ve.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Rf
ve.createPortal = function (e, n) {
  var t = 2 < arguments.length && arguments[2] !== void 0 ? arguments[2] : null
  if (!yu(n)) throw Error(y(200))
...
var Pa,
  Ta,
  _o = No.exports
;(Ta = _o.createRoot), (Pa = _o.hydrateRoot)
const zi = ({ value: e, name: n }) =>
  e
    ? yn.exports.createElement("astro-slot", {
        name: n,
...
const If =
  ...
  (n, t, { default: r, ...l }, { client: i }) => {
    ...
    for (const [s, d] of Object.entries(l))
      t[s] = yn.exports.createElement(zi, { value: d, name: s })
    const u = yn.exports.createElement(
        n,
        t,
        r != null ? yn.exports.createElement(zi, { value: r }) : r
      ),
      o = Of(e)
    return (
      o && delete e[o],
      i === "only"
        ? yn.exports.startTransition(() => {
            Ta(e).render(u)
          })
        : yn.exports.startTransition(() => {
            Pa(e, u)
